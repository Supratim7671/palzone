...
<div class="col-sm-9" id="refresh">
	...
	<div class="row form-group">
		<textarea cols=120 class="form-control" rows=5 style="padding:5px; resize:none;" required="required" name="post_txt" maxlength="511" placeholder="Share your ideas and issues"></textarea>
	</div>	
...
//	alert("position");
	...
	{
	$.get("timeline_ajax.php",function(data){
		//alert(data);
	...
	window.setTimeout(update_timeline,3000);
	
}
function update_timeline_comment()
{
	...
	if(document.activeElement.tagName!="INPUT" && document.activeElement.tagName!="TEXTAREA")
	{
		$.get("timeline_comment_ajax.php",function(data){
			var pid=document.getElementById(id).elements["post_id"].value;
...
$(window).scrollTop(tempScrollTop);
	...
	window.setTimeout(update_timeline_comment,3000);
