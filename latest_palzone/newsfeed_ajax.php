...
$sql_query = mysqli_query($conn,$sql2);
 ...
 <span class="glyphicon glyphicon-trash"></span>
  ...
  <div class="form-group has-success has-feedback" style="width:100px;">
	...
	<button type="submit" name="Unlike" id="'.$postid.'like" class="btn btn-default btn-sm like-btn" onMouseOver="unlike_underLine('.$postid.')" onMouseOut="unlike_NounderLine('.$postid.')" id="unlike'.$postid.'">
	...
	<form class="form-inline like-form" id="'.$postid.'form" role="form" method="post">
  <div class="form-group has-success has-feedback" style="width:100px;">
    <label class="control-label" for="inputSuccess4"></label>
	...
	<button type="submit" name="Like" id="'.$postid.'like" class="btn btn-default btn-sm like-btn" onMouseOver="like_underLine('.$postid.')" onMouseOut="like_NounderLine('.$postid.')" id="like '.$postid.'">
